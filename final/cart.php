<?php include 'header.php';?>
    <!--cart-->
    <section id="cart">
        <p>Your shopping cart is empty. <a href="login.php">Please log in</a> to see your recent orders. Or explore our current <a href="shop.php">scented candle offering.</a></p>
    </section>
    <!--Footer-->
    <section id="footer">
        <div class="container">
